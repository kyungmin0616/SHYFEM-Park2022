...
%ncid = netcdf.open(['/Users/ifederico/Desktop/sim001_nos0.nc'],'NC_NOWRITE');
%ncid = netcdf.open(['/Users/ifederico/Desktop/sm001_nos0.nc'],'NC_NOWRITE');
%ncid = netcdf.open(['/Users/ifederico/Desktop/sm001longr_nos0.nc'],'NC_NOWRITE');
%ncid = netcdf.open(['/Users/ifederico/Desktop/sim001_056zbc_nos0.nc'],'NC_NOWRITE');

%ncid = netcdf.open(['/Users/ifederico/Desktop/ser_nos.nc'],'NC_NOWRITE');
ncid = netcdf.open(['/Users/ifederico/Desktop/SavannahV1_devnouv_nos0.nc'],'NC_NOWRITE');
...
% time=field{7}.data;
% return
% timestart=nc_attget(ncid,'time','units');
% 
% timestart=timestart(15:30);
% timestart=datestr(datenum(timestart,'yyyy-mm-dd HH:MM'),0);
% timeall=datestr(datenum(timestart)+double(time)./86400,31);
% 
% return
% h= figure;
...
%            title(hcb,'degC','fontsize', 18)
           ...
           saveas(h,sprintf('/Users/kpark350/Ga_tech/Projects/SHYFEM/Output/check/temp_%d.png',its));
...
%                set(graph_handle,'fontsize', 22)
%                set(graph_handle,'linewidth', 1)  
%                saveas(h,sprintf('/Users/ifederico/Desktop/savanna_fc1/salt_%d.png',its));%
%                 % saveas(h,sprintf('/Users/ifederico/Desktop/aaag.png'));
%          
