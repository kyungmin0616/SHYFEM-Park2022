...
% rectangle('Position',[-81.1841 31.9877 0.5341 0.2623],'LineStyle','--','EdgeColor','w','LineWidth',3)
...
% axis([-81.3 -80.65 31.75 32.25]);
axis([-81.1841 -80.65 31.9877 32.25]);
box on;
grid on;
graph_handle= gca;
% xticks(-81.3:0.2:-80.65)
...
set(h1,'Position',[x1 y1 sp_width sp_height]) %using position of subplot1 put subplot2next to it.
set(h2,'Position',[x2 y1 sp_width+EL_CH sp_height]) %using position of subplot1 put subplot2next to it.
set(h3,'Position',[x1 y2 sp_width sp_height]) %using position of subplot1 put subplot2next to it.
set(h4,'Position',[x2 y2 sp_width+EL_CH sp_height]) %using position of subplot1 put subplot2next to it.
...
load /Users/kpark350/Ga_tech/Projects/SHYFEM/Output/SenExp/GoogleMap/ggmap_savcity_larger.mat	
