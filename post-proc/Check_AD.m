...
plot(refDate+time3(1:TP,1)/(60*60*24),sshtime1(1,1:TP)-sshtime2(1,1:TP)+os,'-b','linewidth', 2,'MarkerSize',15); 
...
ylim([-1.5 2.5])
legend({'MT-BS','MT-BS-AD','Diff'},'FontSize',20)
xlabel('Date (2016)')
...
plot(refDate+timed3(1:TP,1)/(60*60*24),sshtime1_d(1,1:TP)-sshtime2_d(1,1:TP)+os,'-b','linewidth', 2,'MarkerSize',15); 
