...
plot(time3(1:TP,1)/(60*60*24),sshtime1(1,1:TP)-(sshtime2(1,1:TP)+sshtime3(1,1:TP))+os,'-m','linewidth', 2,'MarkerSize',15); 

% plot(time4(1:TP,1)/(60*60*24),sshtime4(1,1:TP)+os,'-g','linewidth', 2,'MarkerSize',15); 

axis([1 7 -1.5 2.5]);
legend('MT-local','MT-wind','MT-slp','residual')
xlabel('Days')
...
plot(time3(1:TP,1)/(60*60*24),sshtime1_d(1,1:TP)-(sshtime2_d(1,1:TP)+sshtime3_d(1,1:TP))+os,'-m','linewidth', 2,'MarkerSize',15); 
% plot(timed3(1:168,1)/(60*60*24),sshtime4_d(1,1:168)+os,'-g','linewidth', 2,'MarkerSize',15); 


axis([1 7 -1.5 2.5]);
legend('DR-local','DR-wind','DR-slp','residual')
