...
fileprova = fopen('dorian_surge_ssh_adjust.dat', 'wt');
% fileprova = fopen('matthew_surge_ssh_adjust.dat', 'wt');
...
it = 1008;
% fileprova = fopen('mt_ssh_adjust_6h_fw.dat', 'wt');
fileprova = fopen('dr_ssh_adjust_6h_fw_v3.dat', 'wt');
...
for i=3:168:length-164-it
    ...
    fprintf(fileprova, '\n')
    for j=0:164
    fprintf(fileprova, '%1.12f ', str2double(str2mat(table2array(bdn(i+j+it,1))))-str2double(str2mat(table2array(bdn2(i+j+it,1))))+offn)
    fprintf(fileprova, '\n')
    end
...
% fileprova = fopen('mt_ssh_adjust_tide_6h_fw.dat', 'wt');
fileprova = fopen('dr_ssh_adjust_tide_6h_fw.dat', 'wt');
...
for i=3:168:length-164-it
    ...
    fprintf(fileprova, '\n')
    for j=0:164
    fprintf(fileprova, '%1.12f ', (str2double(str2mat(table2array(bdn(i+j+it,1))))-str2double(str2mat(table2array(bdn2(i+j+it,1))))+offn)+str2double(str2mat(table2array(bdn2(i+j,1)))))
    fprintf(fileprova, '\n')
    end
