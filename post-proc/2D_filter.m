...
%CMEMS
I=find(CMEMS.mttime==datenum('2016-10-08 18:00:00'));
...
h3=subplot(3,5,3);
pcolorjw(CMEMS.LON, CMEMS.LAT, CMEMS.mtssh(:,:,I)-CMEMS.mtssh_lp288(:,:,I)); hold on
SAB_coast
colormap(gca,getpmap(7));
colb=colorbar;
title(colb,'m')
...
%ECMWF
I=find(ECMWF.mttime==datenum('2016-10-08 18:00:00'));
