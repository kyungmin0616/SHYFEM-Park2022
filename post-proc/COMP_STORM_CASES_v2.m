...
% Netcdf file
ncid = netcdf.open(['/Users/kpark350/Ga_tech/Projects/SHYFEM/Output/SenExp/NCFiles/matthew-wo-tide-at-dv-v2.nc'],'NC_NOWRITE');
...
% Netcdf file
ncid = netcdf.open(['/Users/kpark350/Ga_tech/Projects/SHYFEM/Output/SenExp/NCFiles/matthew-wo-tide-oc-dv-v2.nc'],'NC_NOWRITE');
...
% plot(NX(1:skp:end),GA_M(IM(1:skp:end),4)-0.4,'-.k','linewidth',2); 
axis([0 7 -1.5 2.5]);
legend('Observation','Ref.','At-dv','Oc-dv','Hy-dv','Zero-dv','Residual')
xlabel('Days')
ylabel('Water level (m)')
% title("Point "+stn,'FontSize',12)
set(gca, 'FontSize', 28)
...
plot(timed1(1:168,1)/(60*60*24),sshtime1_d(1,1:168)+os,'-k','linewidth', 2); 
