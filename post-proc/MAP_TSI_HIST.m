...
% for i=1:length(ssh1(:,1))
%     
%     [M,mi1]=max(ssh1(i,stt:edt)-(ssh3(i,stt:edt)+ssh5(i,stt:edt)));
%     NL_MT(i,1)=ssh1(i,stt+mi1-1)-(ssh3(i,stt+mi1-1)+ssh5(i,stt+mi1-1));
%     OS_MT(i,1)=ssh3(i,stt+mi1-1);
%     OT_MT(i,1)=ssh5(i,stt+mi1-1);
% 
%     
%     [M,mi2]=max(ssh2(i,stt:edt)-(ssh4(i,stt:edt)+ssh5(i,stt:edt)));
%     NL_MT_6H(i,1)=ssh2(i,stt+mi2-1)-(ssh4(i,stt+mi2-1)+ssh5(i,stt+mi2-1));
%     OS_MT_6H(i,1)=ssh4(i,stt+mi2-1);
%     
%     [M,di1]=max(sshd1(i,stt:edt)-(sshd3(i,stt:edt)+sshd5(i,stt:edt)));
%     NL_DR(i,1)=sshd1(i,stt+di1-1)-(sshd3(i,stt+di1-1)+sshd5(i,stt+di1-1));
%     OS_DR(i,1)=sshd3(i,stt+di1-1);
%     OT_DR(i,1)=sshd5(i,stt+di1-1);
%     
%     [M,di2]=max(sshd2(i,stt:edt)-(sshd4(i,stt:edt)+sshd5(i,stt:edt)));
%     NL_DR_6H(i,1)=sshd2(i,stt+di2-1)-(sshd4(i,stt+di2-1)+sshd5(i,stt+di2-1));
%     OS_DR_6H(i,1)=sshd4(i,stt+di2-1);
%     
% end
...
IV = find(lon>=v_lons & lon <= v_lone & lat >=v_lats & lat <=v_late);
IP = find(lon>=p_lons & lon <= p_lone & lat >=p_lats & lat <=p_late);

test = ssh1(IV,:) * ssh1(IV,:)';
...
hcb=colorbar;
title(hcb,'Depth (m)')
rectangle('Position',[v_lons v_lats v_lone-v_lons v_late-v_lats],'LineStyle','--','EdgeColor','r','LineWidth',3)
rectangle('Position',[p_lons p_lats p_lone-p_lons p_late-p_lats],'LineStyle','--','EdgeColor','r','LineWidth',3)
...
% sum_OSOT = [(OS_MT+OT_MT)./-depth; (OS_MT_6H+OT_MT)./-depth; (OS_DR+OT_DR)./-depth; (OS_DR_6H+OT_DR)./-depth];
sum_OSOT = [OS_MT+OT_MT; OS_MT_6H+OT_MT; OS_DR+OT_DR; OS_DR_6H+OT_DR];
sum_NL = [NL_MT; NL_MT_6H; NL_DR; NL_DR_6H];

figure(2)
clf
box on
histogram2(sum_OSOT,sum_NL,'BinWidth',[0.05 0.01],'DisplayStyle','tile','ShowEmptyBins','off','Normalization','probability','EdgeColor','none')
colorbar
ylim([-0.2 0])
xlim([1.4 2.6])
...
box on
scatter((OS_MT(IDP)+OT_MT(IDP)),NL_MT(IDP),'MarkerEdgeColor','r','MarkerFaceColor','r'); hold on
scatter((OS_MT_6H(IDP)+OT_MT(IDP)),NL_MT_6H(IDP),'MarkerEdgeColor','b','MarkerFaceColor','b')
scatter((OS_DR(IDP)+OT_DR(IDP)),NL_DR(IDP),'MarkerEdgeColor','g','MarkerFaceColor','g')
scatter((OS_DR_6H(IDP)+OT_DR(IDP)),NL_DR_6H(IDP),'MarkerEdgeColor','m','MarkerFaceColor','m')
ylim([-0.2 0])
...
box on
scatter((OS_MT(IDP)+OT_MT(IDP))./-depth(IDP),NL_MT(IDP),'MarkerEdgeColor','r','MarkerFaceColor','r'); hold on
scatter((OS_MT_6H(IDP)+OT_MT(IDP))./-depth(IDP),NL_MT_6H(IDP),'MarkerEdgeColor','b','MarkerFaceColor','b')
scatter((OS_DR(IDP)+OT_DR(IDP))./-depth(IDP),NL_DR(IDP),'MarkerEdgeColor','g','MarkerFaceColor','g')
scatter((OS_DR_6H(IDP)+OT_DR(IDP))./-depth(IDP),NL_DR_6H(IDP),'MarkerEdgeColor','m','MarkerFaceColor','m')
ylim([-0.2 0])
...
%% Histogram ((Surge +tide)/depth to tide vs TSI)
...
subplot(2,2,1)
box on
histogram2((OS_MT(IDP)+OT_MT(IDP))./-depth(IDP),NL_MT(IDP),'BinWidth',[0.05 0.01],'DisplayStyle','tile','ShowEmptyBins','off','Normalization','probability','EdgeColor','none')
xlabel('MT-SO + MT-TO')
ylabel('TSI (m)')
ylim([-0.2 0])
% xlim([1 2.8])
...
subplot(2,2,3)
histogram2((OS_MT_6H(IDP)+OT_MT(IDP))./-depth(IDP),NL_MT_6H(IDP),'BinWidth',[0.05 0.01],'DisplayStyle','tile','ShowEmptyBins','off','Normalization','probability','EdgeColor','none')
xlabel('MT-SO6H + MT-TO')
ylabel('TSI-6H (m)')
ylim([-0.2 0])
% xlim([1 2.8])
colorbar
...
subplot(2,2,2)
histogram2((OS_DR(IDP)+OT_DR(IDP))./-depth(IDP),NL_DR(IDP),'BinWidth',[0.05 0.01],'DisplayStyle','tile','ShowEmptyBins','off','Normalization','probability','EdgeColor','none')
xlabel('DR-SO + DR-OT')
ylabel('TSI (m)')
ylim([-0.2 0])
% xlim([1.6 2.6])
...
subplot(2,2,4)
histogram2((OS_DR_6H(IDP)+OT_DR(IDP))./-depth(IDP),NL_DR_6H(IDP),'BinWidth',[0.05 0.01],'DisplayStyle','tile','ShowEmptyBins','off','Normalization','probability','EdgeColor','none')
xlabel('DR-SO6H + DR-OT')
ylabel('TSI-6H (m)')
ylim([-0.2 0])
% xlim([1.6 2.6])
colorbar
...
%% Histogram for SAV and SAP (Surge +tide to tide vs TSI)
...
subplot(2,2,1)
box on
histogram2(OS_MT(IDP)+OT_MT(IDP),NL_MT(IDP),'BinWidth',[0.05 0.01],'DisplayStyle','tile','ShowEmptyBins','off','Normalization','probability','EdgeColor','none')
xlabel('MT-SO + MT-TO')
ylabel('TSI (m)')
ylim([-0.2 0])
xlim([1 2.8])
...
subplot(2,2,3)
histogram2(OS_MT_6H(IDP)+OT_MT(IDP),NL_MT_6H(IDP),'BinWidth',[0.05 0.01],'DisplayStyle','tile','ShowEmptyBins','off','Normalization','probability','EdgeColor','none')
xlabel('MT-SO6H + MT-TO')
ylabel('TSI-6H (m)')
ylim([-0.2 0])
xlim([1 2.8])
...
subplot(2,2,2)
histogram2(OS_DR(IDP)+OT_DR(IDP),NL_DR(IDP),'BinWidth',[0.05 0.01],'DisplayStyle','tile','ShowEmptyBins','off','Normalization','probability','EdgeColor','none')
xlabel('DR-SO + DR-OT')
ylabel('TSI (m)')
ylim([-0.2 0])
xlim([1.6 2.6])
...
subplot(2,2,4)
histogram2(OS_DR_6H(IDP)+OT_DR(IDP),NL_DR_6H(IDP),'BinWidth',[0.05 0.01],'DisplayStyle','tile','ShowEmptyBins','off','Normalization','probability','EdgeColor','none')
xlabel('DR-SO6H + DR-OT')
ylabel('TSI-6H (m)')
ylim([-0.2 0])
xlim([1.6 2.6])
...
%% According to depth &&& Histogram for SAV and SAP (Ratio of storm surge to tide vs TSI)
...
subplot(2,2,1)
histogram2(OS_MT(IDP)./OT_MT(IDP),NL_MT(IDP),'BinWidth',[0.01 0.01],'DisplayStyle','tile','ShowEmptyBins','on','Normalization','probability','EdgeColor','none')
xlabel('MT-SO / MT-TO')
ylabel('TSI (m)')
ylim([-0.2 0])
colorbar
...
subplot(2,2,2)
histogram2(OS_MT_6H(IDP)./OT_MT(IDP),NL_MT_6H(IDP),'BinWidth',[0.01 0.01],'DisplayStyle','tile','ShowEmptyBins','on','Normalization','probability','EdgeColor','none')
xlabel('MT-SO6H / MT-TO')
ylabel('TSI-6H (m)')
ylim([-0.2 0])
colorbar
...
subplot(2,2,3)
histogram2(OS_DR(IDP)./OT_DR(IDP),NL_DR(IDP),'BinWidth',[0.01 0.01],'DisplayStyle','tile','ShowEmptyBins','on','Normalization','probability','EdgeColor','none')
xlabel('DR-SO / DR-OT')
ylabel('TSI (m)')
ylim([-0.2 0])
colorbar
...
subplot(2,2,4)
histogram2(OS_DR_6H(IDP)./OT_DR(IDP),NL_DR_6H(IDP),'BinWidth',[0.01 0.01],'DisplayStyle','tile','ShowEmptyBins','on','Normalization','probability','EdgeColor','none')
xlabel('DR-SO6H / DR-OT')
ylabel('TSI-6H (m)')
ylim([-0.2 0])
colorbar
...
clf
% subplot(2,1,1)
scatter(OT_MT./max_MT,NL_MT); hold on
scatter(OT_MT(IV)./max_MT(IV),NL_MT(IV))
scatter(OT_MT(IP)./max_MT(IP),NL_MT(IP))
legend('Total','SAV','SAP')
...
%% Histogram for SAV and SAP (Ratio of storm surge to tide vs TSI)
...
subplot(2,2,1)
histogram2(OS_MT(IV)./OT_MT(IV),NL_MT(IV),'BinWidth',[0.01 0.01],'DisplayStyle','tile','ShowEmptyBins','on','Normalization','probability','EdgeColor','none')
xlabel('MT-SO / MT-TO')
ylabel('TSI (m)')
colorbar
set(gca,'fontsize', 18)
...
subplot(2,2,2)
histogram2(OS_MT_6H(IV)./OT_MT(IV),NL_MT_6H(IV),'BinWidth',[0.01 0.01],'DisplayStyle','tile','ShowEmptyBins','on','Normalization','probability','EdgeColor','none')
xlabel('MT-SO6H / MT-TO')
ylabel('TSI-6H (m)')
colorbar
set(gca,'fontsize', 18)
...
subplot(2,2,3)
histogram2(OS_DR(IV)./OT_DR(IV),NL_DR(IV),'BinWidth',[0.01 0.01],'DisplayStyle','tile','ShowEmptyBins','on','Normalization','probability','EdgeColor','none')
xlabel('DR-SO / DR-OT')
ylabel('TSI (m)')
colorbar
set(gca,'fontsize', 18)
...
subplot(2,2,4)
histogram2(OS_DR_6H(IV)./OT_DR(IV),NL_DR_6H(IV),'BinWidth',[0.01 0.01],'DisplayStyle','tile','ShowEmptyBins','on','Normalization','probability','EdgeColor','none')
xlabel('DR-SO6H / DR-OT')
ylabel('TSI-6H (m)')
colorbar
set(gca,'fontsize', 18)
...
subplot(2,2,1)
histogram2(OS_MT(IP)./OT_MT(IP),NL_MT(IP),'BinWidth',[0.01 0.01],'DisplayStyle','tile','ShowEmptyBins','on','Normalization','probability','EdgeColor','none')
xlabel('MT-SO / MT-OT')
ylabel('TSI (m)')
colorbar
set(gca,'fontsize', 18)
...
subplot(2,2,2)
histogram2(OS_MT_6H(IP)./OT_MT(IP),NL_MT_6H(IP),'BinWidth',[0.01 0.01],'DisplayStyle','tile','ShowEmptyBins','on','Normalization','probability','EdgeColor','none')
xlabel('MT-SO6H / MT-OT')
ylabel('TSI-6H (m)')
colorbar
set(gca,'fontsize', 18)
% caxis([0 300])
...
subplot(2,2,3)
histogram2(OS_DR(IP)./OT_DR(IP),NL_DR(IP),'BinWidth',[0.01 0.01],'DisplayStyle','tile','ShowEmptyBins','on','Normalization','probability','EdgeColor','none')
xlabel('DR-SO / DR-OT')
ylabel('TSI (m)')
colorbar
set(gca,'fontsize', 18)
...
subplot(2,2,4)
histogram2(OS_DR_6H(IP)./OT_DR(IP),NL_DR_6H(IP),'BinWidth',[0.01 0.01],'DisplayStyle','tile','ShowEmptyBins','on','Normalization','probability','EdgeColor','none')
xlabel('DR-SO6H / DR-OT')
ylabel('TSI-6H (m)')
colorbar
set(gca,'fontsize', 18)
...
subplot(2,2,2)
histogram2(OT_MT_6H(IV)./max_MT_6H(IV),NL_MT_6H(IV),'BinWidth',[0.01 0.01],'DisplayStyle','tile','ShowEmptyBins','on','Normalization','probability','EdgeColor','none')
...
subplot(2,2,4)
histogram2(OT_DR_6H(IV)./max_DR_6H(IV),NL_DR_6H(IV),'BinWidth',[0.01 0.01],'DisplayStyle','tile','ShowEmptyBins','on','Normalization','probability','EdgeColor','none')
...
subplot(2,2,2)
histogram2(OT_MT_6H(IP)./max_MT_6H(IP),NL_MT_6H(IP),'BinWidth',[0.01 0.01],'DisplayStyle','tile','ShowEmptyBins','on','Normalization','probability','EdgeColor','none')
xlabel('MT-TO / MT-ST6H')
ylabel('TSI-6H (m)')
colorbar
set(gca,'fontsize', 18)
...
subplot(2,2,4)
histogram2(OT_DR_6H(IP)./max_DR_6H(IP),NL_DR_6H(IP),'BinWidth',[0.01 0.01],'DisplayStyle','tile','ShowEmptyBins','on','Normalization','probability','EdgeColor','none')
xlabel('DR-TO / DR-ST6H')
ylabel('TSI-6H (m)')
colorbar
set(gca,'fontsize', 18)
...
subplot(2,2,1)
histogram2(OT_MT./max_MT*100,NL_MT*100,'BinWidth',[1 1],'DisplayStyle','tile','ShowEmptyBins','on','Normalization','probability','EdgeColor','none')
xlabel('Tide at peak level of MT-ST (%)')
ylabel('TSI (cm)')
colorbar
set(gca,'fontsize', 18)

subplot(2,2,2)
histogram2(OT_DR./max_DR*100,NL_DR*100,'BinWidth',[1 1],'DisplayStyle','tile','ShowEmptyBins','on','Normalization','probability','EdgeColor','none')
xlabel('Tide at peak level of DR-ST (%)')
ylabel('TSI (cm)')
colorbar
set(gca,'fontsize', 18)
...
subplot(2,2,3)
histogram2(OT_MT_6H./max_MT_6H*100,NL_MT_6H*100,'BinWidth',[1 1],'DisplayStyle','tile','ShowEmptyBins','on','Normalization','probability','EdgeColor','none')
xlabel('Tide at peak level of MT-ST6H (%)')
ylabel('TSI-6H (cm)')
colorbar
set(gca,'fontsize', 18)

subplot(2,2,4)
histogram2(OT_DR_6H./max_DR_6H*100,NL_DR_6H*100,'BinWidth',[1 1],'DisplayStyle','tile','ShowEmptyBins','on','Normalization','probability','EdgeColor','none')
xlabel('Tide at peak level of DR-ST6H (%)')
ylabel('TSI-6H (cm)')
colorbar
set(gca,'fontsize', 18)
set(gcf,'color','w')
...
subplot(2,2,2)
histogram2(OT_MT_6H,NL_MT_6H,'BinWidth',[0.01 0.01],'DisplayStyle','tile','ShowEmptyBins','on','Normalization','pdf')
xlabel('MT-TO')
ylabel('TSI-6H (m)')
colorbar
set(gca,'fontsize', 18)
