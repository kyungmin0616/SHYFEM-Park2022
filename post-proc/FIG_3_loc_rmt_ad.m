...
h1=subplot(2,2,1);
startDate = datenum('10-06-2016'); %Entire period
...
h2=subplot(2,2,2);
os=0;
startDate = datenum('09-03-2019'); %Entire period
...
plot(refDate+timed3(1:TP,1)/(60*60*24),sshtime3_d(1,1:TP)+os,'-b','linewidth', 2,'MarkerSize',15); hold on
...
plot(refDate+time3(1:TP,1)/(60*60*24),sp_sshtime3(1,1:TP)+os,'-b','linewidth', 2,'MarkerSize',15); 
...
plot(refDate+timed3(1:TP,1)/(60*60*24),sp_sshtime3_d(1,1:TP)+os,'-b','linewidth', 2,'MarkerSize',15); hold on
