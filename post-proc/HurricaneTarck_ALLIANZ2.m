...
% set(h,'AlphaData',1)
% 
% save ggmap_southeast.mat lonVec latVec imag
...
%Stations
plot(-80.9,32.036,'wd','MarkerSize',sz2,'markerfacecolor','w','LineWidth',2); %Fort Pulaski
plot(-81.428,30.398,'wd','MarkerSize',sz2,'markerfacecolor','w','LineWidth',2); %Mayport
plot(-80.59333,28.415,'wd','MarkerSize',sz2,'markerfacecolor','w','LineWidth',2); %Wilmington
plot(-79.9233,32.78,'wd','MarkerSize',sz2,'markerfacecolor','w','LineWidth',2); %Charleston
plot(-77.9533,34.226666,'wd','MarkerSize',sz2,'markerfacecolor','w','LineWidth',2); %Wilmington
