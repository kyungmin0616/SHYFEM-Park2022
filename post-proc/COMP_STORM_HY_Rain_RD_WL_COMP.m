...
% Netcdf file
ncid = netcdf.open(['/Users/kpark350/Ga_tech/Projects/SHYFEM/Output/SenExp/NCFiles/matthew-wo-tide-hy-dv-no-rain.nc'],'NC_NOWRITE');
...
plot(time1(1:168,1)/(60*60*24),sshtime1(1,1:168)+os,'ok','linewidth', 2); hold on
...
axis([0 7 -1.5 2.5]);
legend('Hy-dv','Only river','Only rain')
...
legend('Ref.','Hy-fz-bc','Hy-zero-bc')
