...
ncid = netcdf.open(['/Users/kpark350/Ga_tech/Projects/SHYFEM/Output/SenExp/NCFiles/mathew-wo-tide-hy-dv-v2_nos.nc'],'NC_NOWRITE');
...
% parameters for map
salt=squeeze(field{5}.data);
temp=squeeze(field{6}.data);
clear field

ncid = netcdf.open(['/Users/kpark350/Ga_tech/Projects/SHYFEM/Output/SenExp/NCFiles/mathew-wo-tide-at-dv_nos.nc'],'NC_NOWRITE');
...
% parameters for map
salt2=squeeze(field{5}.data);
temp2=squeeze(field{6}.data);
clear field

ncid = netcdf.open(['/Users/kpark350/Ga_tech/Projects/SHYFEM/Output/SenExp/NCFiles/mathew-wo-tide-oc-dv_nos.nc'],'NC_NOWRITE');
...
% parameters for map
salt3=squeeze(field{5}.data);
temp3=squeeze(field{6}.data);
clear field
...
ncid = netcdf.open(['/Users/kpark350/Ga_tech/Projects/SHYFEM/Output/SenExp/NCFiles/matthew-wo-tide-hy-dv-no-rd.nc'],'NC_NOWRITE');
...
ssh3=field{10}.data;
u3=squeeze(field{8}.data);
v3=squeeze(field{9}.data);
clear field


%% Dorian

ncid = netcdf.open(['/Users/kpark350/Ga_tech/Projects/SHYFEM/Output/SenExp/NCFiles/dorian-wo-tide-hy-dv-v2_nos.nc'],'NC_NOWRITE');
...
% parameters for map
saltd=squeeze(field{5}.data);
tempd=squeeze(field{6}.data);
clear field


ncid = netcdf.open(['/Users/kpark350/Ga_tech/Projects/SHYFEM/Output/SenExp/NCFiles/dorian-wo-tide-at-dv_nos.nc'],'NC_NOWRITE');
...
% parameters for map
saltd2=squeeze(field{5}.data);
tempd2=squeeze(field{6}.data);
clear field

ncid = netcdf.open(['/Users/kpark350/Ga_tech/Projects/SHYFEM/Output/SenExp/NCFiles/dorian-wo-tide-oc-dv_nos.nc'],'NC_NOWRITE');
...
% parameters for map
saltd3=squeeze(field{5}.data);
tempd3=squeeze(field{6}.data);
clear field
...
ssh1d=field{10}.data;
u1d=squeeze(field{8}.data);
v1d=squeeze(field{9}.data);
clear field

refdate2 = datenum('2019-09-01 00:00:00');

ncid = netcdf.open(['/Users/kpark350/Ga_tech/Projects/SHYFEM/Output/SenExp/NCFiles/dorian-wo-tide-hy-dv-new-rd-no-rain.nc'],'NC_NOWRITE');
...
ssh2d=field{10}.data;
u2d=squeeze(field{8}.data);
v2d=squeeze(field{9}.data);
clear field
...
%     timestamp2=datestr(refdate2+((its-1)/24),'yyyy-mm-dd HH:MM:SS');
    ...
    colormap(getpmap(7));
    %            colorbar;axis equal
    title(['\color{black}MT-HY-NEW-RD: ',timestamp],'FontSize',22);
    ...
    colormap(getpmap(7));
    %            colorbar;axis equal
    title(['\color{black}MT-HY-NO-RD: ',timestamp],'FontSize',22);
    %            xlabel('Longitude (deg)','FontSize',22);
    %            ylabel('Latitude (deg)','FontSize',22);
    axis([min_lon max_lon min_lat max_lat]);
    %            axis([-81.2 -80.8 32 32.3]);
    ...
    colormap(getpmap(7));
    %            colorbar;axis equal
    title(['\color{black}MT-HY-NO-RAIN: ',timestamp],'FontSize',22);
    %            xlabel('Longitude (deg)','FontSize',22);
    %            ylabel('Latitude (deg)','FontSize',22);
    axis([min_lon max_lon min_lat max_lat]);
    %            axis([-81.2 -80.8 32 32.3]);
...
for its=25:1:144 %48, nt
    ...
    colormap(getpmap(7));
    %            colorbar;axis equal
    title(['\color{black}MT-HY: ',timestamp],'FontSize',22);
    %            xlabel('Longitude (deg)','FontSize',22);
    %            ylabel('Latitude (deg)','FontSize',22);
    axis([min_lon max_lon min_lat max_lat]);
    %            axis([-81.2 -80.8 32 32.3]);
    ...
    colormap(getpmap(7));
    %            colorbar;axis equal
    title(['\color{black}DR-HY: ',timestamp2],'FontSize',22);
    %            xlabel('Longitude (deg)','FontSize',22);
    %            ylabel('Latitude (deg)','FontSize',22);
    axis([min_lon max_lon min_lat max_lat]);
    %            axis([-81.2 -80.8 32 32.3]);
